...
{{--                <input type="text" name="query_email" placeholder="Search by Email"/>--}}
                  <input list="emails" name="query_email" id="query_email" placeholder="Search by Email">
...
{{--                                       <td>${{ $account->new_balance }}</td>--}}
              ...
              <div class="row justify-content-center mt-5">
                  @if (request()->query_email)
                      <a href="/accounts/{{ Request::segment(2) }}" class="btn btn-secondary col-2 me-2">Back</a>
                  @else
